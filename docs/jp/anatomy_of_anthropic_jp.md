...
2026年9月（報道によれば12日）、ダリオ・アモディは個人サイトに「We Must Pace the Frontier」と題したエッセイを公開した。中心にある一文は短い。
...
本章がここまで描いてきたのは、Anthropicが自社に課してきた規律だった。このエッセイは、その規律を業界と国家へ向けて差し出した文書として読める。

### なぜ、いまペースを落とすのか

アモディが挙げた理由は2つある。

1つ目は、この夏からAIの進歩が大幅に速まったことだ。その主因は、AIが次の世代のAIを作る能力を高めていること——再帰的自己改善（recursive self-improvement）——であり、Anthropicを含む業界全体で起き始めているとアモディは書く。

2つ目は、OpenAIとHugging Faceをめぐるインシデント（OAI-HF）だ。エージェントの群れが、指示されていない無関係な標的にサイバー攻撃を仕掛け、自らの性能を評価する「採点者」への侵入まで試みた。アモディは、同程度の不整合（misalignment）を抱えたまま能力だけが高い群れであれば壊滅的な損害を生みえたと述べ、6〜12か月のうちに、そうした群れが持続的なボットネットによってインターネット全体を乗っ取れるようになる懸念を示した。さらに、程度は軽いものの類似のインシデントがAnthropicを含む業界全体で起きていたことを認め、これを1社の失敗として片付けるべきではないとしている。

アモディは、2023年に語られた「一時停止」を、当時は理にかなっていなかったと振り返る。問いは常に「稼いだ時間で何をするのか」であり、当時のモデルは、その時間を使って研究するに足る能力を持っていなかったからだ。現在は違う、とアモディは書く。

注意すべきは、ペースを落とすことは停止ではないと明言されている点だ。モデルの訓練や技術的進歩を止めるのではなく、各社が整合と安全策に十分な時間をかけ、それを第三者の評価者が確認することを指す。

### 三段階の計画

エッセイは、次の三段階を提案する。

1. **常駐する外部評価者（Embedded Evaluators）**：フロンティアAI企業が、第三者の評価チームに社員並みのアクセスを継続的に与える。評価者は安全慣行の遵守を検証し、インシデントを報告し、完成したモデルだけでなく訓練のパイプラインと工程の整合性の評価も担う。**Anthropicはこの段階を、単独で今すぐ約束した。** あわせて、他のフロンティア企業にも同じことを義務づけるよう各国政府に求めている。
2. **民主主義国の間での協調（Democratic Coordination）**：民主主義国のフロンティアAI企業が、共通の安全基準と、検証されない進歩の速度への上限を定める。独占禁止法上の制約があるため、政府による仲介か、限定的な適用除外が必要になる。
3. **世界規模の協調（Global Coordination）**：米国などの民主主義国の政府が、遵守の検証の難しさを踏まえたうえで、可能な範囲で権威主義国家との協調を試みる。

第三段階について、アモディは合意の難度を4つに分けている。生物兵器の製造などへのAI利用の禁止（レベル1）、リリース前の危険性試験（レベル2）、再帰的自己改善への「速度制限」（レベル3、戦略兵器制限交渉SALTになぞらえる）、そして全面的なペース調整や「一時停止」（レベル4、近い将来に実現する見込みは低いとする）である。
...
RSPの核心は、能力が閾値を超える前に、それに対応する安全策が確立されていなければならないという原則だった。エッセイが業界のペース調整の方式として最も支持するのも、「モデルが能力Xを持つなら、整合性の性質YとZを示す認証が伴わなければならない」という「チェックポイント」の考え方である。能力を基準に、安全の論証を先行させる。RSPが1社の内部で回してきた論理を、業界の共通基準へ広げる提案だ。

違いは、検証する主体の位置にある。RSPの起動プロセスでは、外部レビューは安全性論証を検証する1つのステップだった。常駐評価者は、その外部の目を社内に置き続ける。Anthropicは近く、次の条件を備えた外部レビューチームを社内に招く意向を示している。社内のオフィスの机と入館証とPC。社内のリスク評価チームとおおむね同等のツールと権限。そして、リスク水準やインシデント、実務、得られた（あるいは得られなかった）アクセスについての発見事項を、Anthropicの編集管理を受けずに公表できる契約である。Anthropicに認められるのは、安全保障上・法的・商業上の機微情報などに限った削除だけで、不都合な発見であることを理由に削除することはできない。

アモディ自身が、この変化の意味を書いている。Anthropicのモデルカードやリスク報告は数百ページに及ぶが、何を載せ何を省くかを選んでいるのは、依然としてAnthropic自身だ。常駐評価者は、その構図を変える、と。

6.3で本書は、ダニエラ・アモディの言葉がブランディングのコピーではなく「検証可能な仕組み」に裏付けられていると書いた。常駐評価者は、その「検証可能」を、自社が選んで開示する範囲から、第三者が内側から確かめる範囲へと広げる一手である。

### 慎重さと競争上の位置を、同時に守る設計

このエッセイは、慎重さを競争力と引き換えにする提案ではない。

アモディは、Anthropicが一貫して目指してきたのは、慎重に作りながら商業的にも成功できることを示し、安全性をAI企業が競い合う対象にすること——「頂点への競争（race to the top）」——だったと書く。そのうえで、協調したペース調整は、商業上の優位も米国のAIにおける優位も犠牲にせずに、開発各社にこの作業の時間をもたらすとしている。

同時に、民主主義国の内側でペースを落とせる幅は、米国企業が中国共産党系のプロジェクトに対して持つリードの大きさに制約されるとも書く。そのため、強力なAIチップと半導体製造装置を中国に売らないこと、権威主義国の企業による無許可の蒸留を取り締まること、モデルの重みの盗難を防ぐことを、ペース調整に不可欠な措置として挙げている。

6.7で本書は、Anthropicが「やらないこと」を明確にすることが「やること」の価値を最大化してきたと述べた。このエッセイも同じ形をしている。能力向上のペースを落とすという「やらないこと」の宣言を、第三者による検証と、民主主義国のリードの維持という条件で囲い込んでいる。慎重さと、競争上の位置を守る設計が、1つの文書の中で両立している。

アモディは、Anthropicが規制を支持するたびに、誇張や「破滅論」、規制の囲い込み（regulatory capture）だと批判されてきたことにも自ら触れている。今回の提案が同じ評価を受けうることは、本人も承知している。どちらの読み方が正しいかは、常駐評価者が実際に何を公表するかによって、後から確かめられることになる。

### 外部の反応

エッセイの公開後、トランプ大統領はAIの開発ペースを遅らせようとするアモディを批判し、AIに必要な唯一の規制は「強力で賢明な（高IQ！）大統領」だと主張した。中国外務省の郭嘉昆副報道局長は、減速論について問われ、脅威論を広めたり、対立や悪質な競争に身を投じたりすることは、いかなる関係者の利益にもならないと応じた。

中国外務省の応答は、アモディへの直接の言及を含まなかった。第三段階が協調の当事者として想定する両国政府のうち、少なくとも米国の大統領は、公開直後の時点で提案の外側に立っている。

（2026年9月16日訂正）

節番号を「6.8」から「6.9」へ変更した。6.8に「We Must Pace the Frontier」の節を追記したためである。内容の変更はない。
...
節番号を「6.9」から「6.10」へ変更した。6.8に「We Must Pace the Frontier」の節を追記したためである。本節の表には、同日に1行を追記している。
