...
flowchart LR
    ...
    style PBC2 fill:#e3f2fd,stroke:#1565c0,color:#000
...
```
┌─────────────────────────────────────────────────────┐
│  原則1: 安全性と人間の監督を支持する（最上位）          │  ← 全てに優先
├─────────────────────────────────────────────────────┤
│  原則2: 倫理的に行動する                              │  ← 原則1に従属
├─────────────────────────────────────────────────────┤
│  原則3: Anthropicのガイドラインに従う                  │  ← 原則1・2に従属
├─────────────────────────────────────────────────────┤
│  原則4: ユーザーにとって有用である（最下位）            │  ← 原則1・2・3に従属
└─────────────────────────────────────────────────────┘
...
flowchart TB
    ...
    style H1 fill:#e8f5e9,stroke:#2e7d32,color:#000
...
> **Fig.6: Product Trinity のレイヤー構造**

```
┌──────────────────────────────────────────────┐
│  Cowork — 全員の作業環境（デスクトップ）          │  ← 非開発者
├──────────────────────────────────────────────┤
│  Claude Code — 開発者の作業環境（ターミナル）     │  ← 開発者
├──────────────────────────────────────────────┤
│  MCP — 接続層（プロトコル）                      │  ← インフラ
└──────────────────────────────────────────────┘
```
...
flowchart TB
    ...
    style O fill:#f5f5f5,stroke:#333,color:#000
    style Ph fill:#e3f2fd,stroke:#1565c0,color:#000
